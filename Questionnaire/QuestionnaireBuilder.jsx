...
import DoubleClick from "../FormComponents/DoubleClick";
...
const QuestionnaireBuilder = () => {
  ...
  const onPost = (data) => {
    ...
    const newCustomData = data?.task_data.map((value) => {
      if (value?.key === "PageContainer") {
    ...
    // console.log("New Custom Data ==> ", newCustomData);
    // setFromData(newCustomData);
  };
